  ...
  return (
    <section className="mb-10">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
            {
                svgs?.map((svg)=>(
                    <div className="w-full md:w-2/5 xl:w-72 flex flex-col justify-center items-center p-4 m-4  rounded-md  border-violet-800 border-2 dark:bg-gray-900" key={svg.name}>
