...
const Projects = () => {
  return (
    <section className="w-full m-auto text-white pt-20" id="proyectos">
      <div className="w-[80%] 2xl:w-[70%] m-auto">
        <h2 className="text-center text-5xl font-bold mb-8">Proyectos</h2>
        <div className="flex flex-wrap gap-4 justify-center">
          {
            proyects?.map((proyect, index)=>(
              <div className="w-full md:w-2/5 flex flex-col justify-center items-center p-4 m-4 bg-slate-900 rounded-md border" key={index}>
