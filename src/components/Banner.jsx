    ...
    <section className="w-full m-auto h-screen text-white">
        <div className="w-[80%] 2xl:w-[70%] flex flex-col justify-center items-center h-full  my-0 mx-auto text-center">
            <div className="flex flex-col gap-4 my-8 mx-auto">
                <code className="font-bold 2xl:text-3xl text-4xl">
                    <span>&#60;</span><span>holaMundo</span><span>/&#62;</span>
                </code>
                <p className=" 2xl:text-3xl text-2xl font-bold">soy</p>
                <h1 className=" 2xl:text-8xl  text-7xl font-bold text-violet-500">Carlos Benites</h1>
                <p className=" 2xl:text-3xl text-2xl font-bold">Software Developer</p>
            </div>
