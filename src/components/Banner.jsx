...
const Banner = () => {
  return (
    <section className="w-full m-auto h-screen text-white">
        <div className="w-[90%] flex flex-col justify-center items-center h-full  my-0 mx-auto text-center">
            ...
            <div className=" flex flex-col md:flex-row">
                <a className="p-4 m-4 rounded-lg bg-violet-500 hover:shadow-lg hover:shadow-violet-500/50 duration-300 flex gap-2  items-center text-xl" href="" > 
